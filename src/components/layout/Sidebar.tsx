      ...
      >
        <div className="p-4 border-b border-border">
          <div className="flex items-center space-x-2">
            {/* Placeholder for Logo, using a simple styled div as in context */}
        ...
        <div className="p-4 border-t border-border">
          {footerNavItems.map((item) => (
            <a
              ...
              href={item.href}
              className={cn(
                'group flex items-center px-3 py-2.5 rounded-md text-sm font-medium text-foreground hover:bg-background hover:text-foreground'
              )}
            >
